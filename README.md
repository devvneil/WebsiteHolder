# Fable Showcase Websites

Two websites designed and built end-to-end by Claude Fable to demonstrate web design capability.

| Site | Live URL | Concept |
| --- | --- | --- |
...
Deployed to Netlify by the `deploy-netlify` GitHub Actions workflow (zip deploy, no build step).
